...
export default function AppliedCapabilitiesPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* SECTION 1 — INTERACTIVE CAPABILITY SYSTEM */}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 space-y-3">
              <h2 className="text-3xl lg:text-4xl font-bold">How You Did in This Conversation</h2>
      ...
      {/* SECTION 3 — STATIC SUMMARY GRID (NON-INTERACTIVE) */}
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
