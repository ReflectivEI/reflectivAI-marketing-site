          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 space-y-3">
              ...
              <div className="text-base text-muted-foreground max-w-3xl mx-auto space-y-1">
                <p>ReflectivAI evaluates communication using eight Signal Intelligence™ capabilities.</p>
                <p>Each capability focuses on observable behaviors during structured practice.</p>
              </div>
            </div>
