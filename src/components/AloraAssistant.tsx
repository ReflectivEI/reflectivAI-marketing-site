...
const ALORA_RESPONSES: Record<string, string> = {
  ...
  about: "ReflectivAI is an AI-powered sales enablement platform purpose-built for life sciences. We help pharma reps master stakeholder conversations through realistic role-play scenarios, real-time coaching, and Signal Intelligence metrics. Our platform combines clinical accuracy with conversational excellence.",
  ...
  signal: "Signal Intelligence is our proprietary framework for measuring conversational excellence. It combines 8 core capabilities—Accuracy, Empathy, Clarity, Compliance, Discovery, Objection Handling, Active Listening, and Emotional Adaptability—to help reps master stakeholder engagement.",
