...
const ALORA_RESPONSES: Record<string, string> = {
  ...
  features: "ReflectivAI offers several powerful features: AI Coach for personalized feedback, Role Play Simulator with 9+ pharma scenarios, 6 Signal Intelligence™ competencies (Communication Clarity, Intent Alignment, Responsiveness, Conversational Balance, Behavioral Adaptability, Outcome Orientation), and comprehensive Signal Intelligence tracking. Which would you like to explore?",
  ...
  'ai coach': "Our AI Coach provides real-time, personalized coaching across 6 Signal Intelligence™ competencies. It analyzes your conversations, identifies patterns, and offers actionable feedback to help you refine judgment and build stronger stakeholder relationships. Would you like to see how it works?",
  ...
  metrics: "We track 6 core Signal Intelligence™ competencies: Communication Clarity, Intent Alignment, Responsiveness, Conversational Balance, Behavioral Adaptability, and Outcome Orientation. Each competency is observable, behavioral, and directly tied to conversation outcomes.",
  ...
  'how it works': "ReflectivAI combines AI-powered role-play scenarios with real-time Signal Intelligence™ coaching. You practice conversations, receive instant feedback on 6 key competencies, and build judgment through structured modules. It's like having a personal coach available 24/7!",
  ...
  signal: "Signal Intelligence™ is the core framework of ReflectivAI. It highlights patterns in how conversations unfold—such as pacing, clarity, and engagement—using observable, behavioral signals. These insights support reflection and improvement, while judgment and decisions remain with the professional. If a response would feel inappropriate if the roles were reversed, it is outside the Signal Intelligence boundary.",
