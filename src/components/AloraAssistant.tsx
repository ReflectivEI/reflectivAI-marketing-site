...
const ALORA_RESPONSES: Record<string, string> = {
  ...
  features: "ReflectivAI offers several powerful features: AI Coach for personalized feedback, Role Play Simulator with 9+ pharma scenarios, 8 Signal Intelligence capabilities (Question Quality, Listening & Responsiveness, Conversation Control, Adaptability, Commitment Gaining, Objection Navigation, Clinical Accuracy, Compliance), and comprehensive Signal Intelligence tracking. Which would you like to explore?",
  about: "ReflectivAI is built on Signal Intelligence™—the operating system that transforms conversations into measurable, improvable performance. We detect, score, and learn from observable behaviors in real-time, then apply emotional intelligence frameworks to help your team understand, adapt, and perform better. Purpose-built for life sciences sales.",
  'ai coach': "Our AI Coach provides real-time, personalized coaching across 8 Signal Intelligence dimensions. It analyzes your conversations, identifies areas for improvement, and offers actionable feedback to help you build stronger stakeholder relationships. Would you like to see how it works?",
  'role play': "The Role Play Simulator lets you practice with realistic pharma scenarios across HIV, Oncology, Cardiology, Vaccines, COVID, and Rare Disease. You'll receive instant feedback on your Signal Intelligence capabilities and sales techniques. Ready to try it?",
  metrics: "We track 8 core Signal Intelligence capabilities: Question Quality, Listening & Responsiveness, Conversation Control, Adaptability, Commitment Gaining, Objection Navigation, Clinical Accuracy, and Compliance. Each metric is observable, behavioral, and directly tied to conversation outcomes.",
  ...
  'how it works': "ReflectivAI combines AI-powered role-play scenarios with real-time Signal Intelligence coaching. You practice conversations, receive instant feedback on 8 key capabilities, and build skills through structured modules. It's like having a personal coach available 24/7!",
  ...
  results: "Our customers see measurable results: 94% clinical accuracy, 92% question quality, and 100% compliance. Teams report improved confidence, better relationships with HCPs, and faster onboarding for new reps.",
  ...
  signal: "Signal Intelligence™ is the core operating system of ReflectivAI. It detects, scores, and learns from observable behaviors in real-time conversations—what was said, when, how, and with what consequence. We then apply emotional intelligence frameworks to explain why those behaviors worked or failed. Think of it this way: Signal Intelligence captures what happened, emotional intelligence explains why it mattered.",
...
const KEYWORD_GROUPS = {
  ...
  signal: ['signal intelligence', 'what is signal intelligence', 'signal capabilities', 'si framework'],
