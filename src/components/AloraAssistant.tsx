...
const ALORA_RESPONSES: Record<string, string> = {
  ...
  'role play': "The Role Play Simulator lets you practice with realistic pharma scenarios across HIV, Oncology, Cardiology, Vaccines, COVID, and Rare Disease. You'll receive instant feedback on your Signal Intelligence™ competencies and sales techniques. Ready to try it?",
