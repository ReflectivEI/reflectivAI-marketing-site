...
const ALORA_RESPONSES: Record<string, string> = {
  ...
  features: "ReflectivAI offers several powerful features: AI Coach for personalized feedback, Role Play Simulator with 9+ pharma scenarios, 8 Signal Intelligence capabilities (Accuracy, Empathy, Clarity, Compliance, Discovery, Objection Handling, Active Listening, Emotional Adaptability), and comprehensive Signal Intelligence tracking. Which would you like to explore?",
  ...
  'ai coach': "Our AI Coach provides real-time, personalized coaching across 10 Signal Intelligence dimensions. It analyzes your conversations, identifies areas for improvement, and offers actionable feedback to help you build stronger stakeholder relationships. Would you like to see how it works?",
